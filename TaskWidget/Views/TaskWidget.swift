...
#Preview(as: .systemSmall) {
    ...
    let tasks = [TaskDTO(id: .init(), parentId: .init(), status: .do, title: "Task1", timeOption: .none, timePeriod: .am, recurring: .daily, reminder: .inOneHour, colorName: "red", checkBoxArray: [], bulletArray: []), TaskDTO(id: .init(), parentId: .init(), status: .do, title: "Task", timeOption: .none, timePeriod: .am, recurring: .daily, reminder: .inOneHour, colorName: "red", checkBoxArray: [], bulletArray: [])]
